    ...
    <div className="space-y-4">
      ...
      <section>
        ...
        <form onSubmit={(e)=>{e.preventDefault(); if(!comment.trim()) return; addComment(confession.id, comment.trim()); setComment('')}} className="mt-3 flex gap-2">
          <input value={comment} onChange={e=>setComment(e.target.value)} className="flex-1 border rounded px-3 py-2 bg-white dark:bg-gray-900" placeholder="Viết bình luận..." />
